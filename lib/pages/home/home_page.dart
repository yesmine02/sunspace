...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint(
      '🏠 DASHBOARD LOAD → Rôle détecté: ${authController.currentRoleType}',
    );

    final String userEmail = authController.currentUser.value?['email'] ?? '';
    final bool isSpecialUser =
        userEmail.toLowerCase() ==
        'authenticated@sunevit.tn'; // Utilisateur spécial pour accès au dashboard moderne même sans rôle étudiant/professionnel
    // Logique de sélection du dashboard en fonction du rôle
    Widget dashboard;
    ...
    return Container(color: const Color(0xFFF8FAFC), child: dashboard);
  }
}
              ...
              if (constraints.maxWidth > 900) {
                return Row(
                  ...
                  children: [
                    ...
                    Expanded(flex: 3, child: _buildMainNavigationCard()),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Bienvenue dans votre espace pédagogique',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Tâches pédagogiques en attente',
...
class _AdminDashboard extends StatelessWidget {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Activité de réservation en temps réel',
                      style: TextStyle(color: Colors.grey[600], fontSize: 13),
                    ),
                  ],
                ),
  ...
  Widget _buildQuickActionItemAdmin(
    String label,
    IconData icon,
    VoidCallback onTap,
  ) {
...
class _AuthenticatedDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final username =
        authController.currentUser.value?['username'] ?? 'authenticated';
