...
class SessionsPage extends StatelessWidget {
          ...
          children: [
            ...
            Obx(() {
              ...
              if (authController.isAdmin) {
                ...
                baseSessions = controller.sessions
          ...
          Row(
            children: [
              Icon(
                ...
                size: 14,
                color: session.type == SessionType.enLigne
                    ? Colors.grey
                    : Colors.orange[700],
              ),
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color:
                        ...
                        : Colors.grey[700],
                    fontSize: 13,
                    fontWeight: session.spaceName != null
                        ? FontWeight.w600
                        : FontWeight.normal,
                  ),
                  overflow: TextOverflow.ellipsis,
          ...
          Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () => Get.dialog(
                  AddEditSessionDialog(session: session),
                ), // BOUTON : Modifier cette session
              ),
              IconButton(
                icon: const Icon(
                ...
                onPressed: () {
                  Get.defaultDialog(
                    ...
                    onConfirm: () {
                      // BOUTON : Confirmer la suppression de la session
  ...
  // 🔹 TABLEAU DESKTOP
  Widget _buildSessionsTableContainer(
    SessionsController controller,
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Get.defaultDialog(
                              title: "Supprimer",
                              middleText:
                                  "Supprimer la session '${session.title}' ?",
                              textConfirm: "Oui",
                              textCancel: "Non",
                              confirmTextColor: Colors.white,
                              buttonColor: Colors.red,
  ...
  // Indicateur de statut (point vert pour Publié, orange pour Brouillon)
