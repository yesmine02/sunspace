...
class _BookSpacePageState extends State<BookSpacePage> {
  ...
  Space?
  selectedSpaceForTooltip; // Stocke l'espace cliqué sur le plan pour afficher sa fiche d'info
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _toggleButton(
              isMobile ? "Plan" : "Plan Interactif",
              showFloorPlan,
              () => setState(() => showFloorPlan = true),
            ),
          ),
          Expanded(
            child: _toggleButton(
              isMobile ? "Liste" : "Liste des Espaces",
              !showFloorPlan,
              () => setState(() => showFloorPlan = false),
            ),
          ),
        ],
      ),
                  ...
                  Center(
                    child: FloorPlanWidget(
                      ...
                      onAreaSelected: (slug) {
                        ...
                        final space = spacesController.spaces.firstWhereOrNull(
                          (s) => s.slug == slug,
                        );
                        setState(() {
                        ...
                        if (space == null) {
                          Get.snackbar(
                            "Info",
                            "Espace '$slug' (données serveur manquantes)",
                          );
                        }
                      },
                    ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () => _handleReservationClick(
                        context,
                        space,
                        bookingController,
                      ),
                      ...
                      child: Text(
                        space.status == SpaceStatus.disponible
                            ? 'Réserver'
                            : 'Indisponible',
                        style: const TextStyle(
                          color: Colors.white,
              ...
              Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Visualisation 3D : ${space.name}',
                      style: const TextStyle(color: Colors.white, fontSize: 24),
                    ),
                    const Text(
                      '(Ici sera intégré le widget ModelViewer ou Unity)',
  ...
  void _handleReservationClick(
    ...
    if (space.status == SpaceStatus.disponible) {
      ...
      _showStatusDialog(
        ...
        title: "Espace Occupé",
        message:
            "Cet espace est actuellement occupé. Veuillez choisir un autre créneau ou un autre espace.",
      ...
      _showStatusDialog(
        ...
        message:
            "Cet espace est actuellement en maintenance pour améliorer nos services. Merci de votre compréhension.",
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              value: Get.find<BookingController>().timeSlots.contains(value)
                  ? value
                  : null,
    ...
    return Obx(() {
      ...
      final dateLabel =
          DateFormat(
              ...
              DateFormat("Aujourd'hui", 'fr').format(DateTime.now())
          ? "Aujourd'hui"
