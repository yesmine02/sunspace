...
class FloorPlanPainter extends CustomPainter {
  ...
  FloorPlanPainter({required this.areas, this.hoveredSlug, this.selectedSlug});
  ...
  static const Color kStatusMaintenance = Color(
    0xFF64748B,
  ); // Gris/Bleu (Maintenance)
  ...
  void _drawAllRooms(Canvas canvas, double sx, double sy) {
    ...
    roomPoly([
      const Offset(571, 22),
      const Offset(1598, 20),
      const Offset(1598, 246),
      const Offset(1507, 248),
      const Offset(1509, 444),
      const Offset(573, 442),
    ...
    room(
      const Rect.fromLTRB(2263, 1237, 2747, 1630),
      _getAreaStatus('espace5'),
    );

    // ── Center-right cluster ───────────────────────────
    roomPoly([
      const Offset(1563, 1520),
      const Offset(1828, 1520),
      const Offset(1828, 1446),
      const Offset(2030, 1444),
      const Offset(2027, 1932),
      const Offset(1558, 1930),
    ...
    roomPoly([
      const Offset(1065, 466),
      const Offset(1507, 464),
      const Offset(1509, 508),
      const Offset(1492, 511),
      const Offset(1492, 837),
      const Offset(1413, 840),
      const Offset(1411, 940),
      const Offset(1065, 943),
    ], _getAreaStatus('espace12'));

    roomPoly([
      const Offset(1499, 516),
      const Offset(1946, 518),
      const Offset(1944, 850),
      const Offset(1558, 854),
      const Offset(1558, 945),
      const Offset(1428, 943),
      const Offset(1426, 845),
      const Offset(1497, 845),
    ...
    _drawHedge(
      canvas,
      [
        const Offset(1500, 430),
        const Offset(2080, 430),
        const Offset(2080, 950),
        const Offset(2000, 950),
        const Offset(2000, 510),
        const Offset(1500, 510),
      ],
      sx,
      sy,
    );
    ...
    _drawHedge(
      canvas,
      [
        const Offset(1480, 1520),
        const Offset(1540, 1520),
        const Offset(1540, 1930),
        const Offset(1480, 1930),
      ],
      sx,
      sy,
    );
  ...
  void _drawAllFurniture(Canvas canvas, double sx, double sy) {
    ...
    _drawConferenceTable(
      canvas,
      const Rect.fromLTRB(680, 60, 940, 200),
      4,
      2,
      sx,
      sy,
    ...
    _drawConferenceTable(
      canvas,
      const Rect.fromLTRB(1000, 60, 1260, 200),
      4,
      2,
      sx,
      sy,
    ...
    _drawConferenceTable(
      canvas,
      const Rect.fromLTRB(2300, 200, 2700, 400),
      6,
      2,
      sx,
      sy,
    ...
    _drawConferenceTable(
      canvas,
      const Rect.fromLTRB(2300, 530, 2700, 700),
      6,
      2,
      sx,
      sy,
    ...
    _drawConferenceTable(
      canvas,
      const Rect.fromLTRB(2300, 900, 2700, 1060),
      6,
      2,
      sx,
      sy,
    ...
    _drawConferenceTable(
      canvas,
      const Rect.fromLTRB(2300, 1280, 2700, 1450),
      6,
      2,
      sx,
      sy,
    ...
    _drawConferenceTable(
      canvas,
      const Rect.fromLTRB(1100, 560, 1470, 760),
      5,
      2,
      sx,
      sy,
    ...
    _drawConferenceTable(
      canvas,
      const Rect.fromLTRB(1540, 570, 1900, 800),
      5,
      2,
      sx,
      sy,
    ...
    _drawConferenceTable(
      canvas,
      const Rect.fromLTRB(860, 1160, 1160, 1460),
      3,
      3,
      sx,
      sy,
  ...
  void _drawInteractiveOverlays(Canvas canvas, double sx, double sy) {
    for (final area in areas) {
      ...
      // Fill
      canvas.drawPath(path, Paint()..color = isSel ? kSelectFill : kHoverFill);
  ...
  void _drawChairs(Canvas canvas, Rect raw, double sx, double sy) {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      _roundRect(
        canvas,
        Rect.fromLTWH(cx - cw / 2, r.top - ch - gap, cw, ch),
        3,
        cp,
        cb,
      );
    ...
    for (int i = 0; i < 2; i++) {
      ...
      _roundRect(
        canvas,
        Rect.fromLTWH(cx - cw / 2, r.bottom + gap, cw, ch),
        3,
        cp,
        cb,
      );
  ...
  void _drawPodGroup(Canvas canvas, Offset origin, double sx, double sy) {
    ...
    // Central table
    canvas.drawCircle(o, r, Paint()..color = kFurniture);
    canvas.drawCircle(
      o,
      r,
      Paint()
    ...
    for (int i = 0; i < 4; i++) {
      ...
      final co = Offset(
        o.dx + math.cos(angle) * (r + 15 * math.min(sx, sy)),
  ...
  void _drawWCBlock(Canvas canvas, Rect raw, double sx, double sy) {
    ...
    _drawToilet(canvas, Rect.fromLTWH(r.left, r.top, stallW, r.height), sx, sy);
    _drawToilet(canvas, Rect.fromLTWH(midX, r.top, stallW, r.height), sx, sy);
  }
  ...
  void _drawElevator(Canvas canvas, Rect raw, double sx, double sy) {
    ...
    canvas.drawLine(
      Offset(px - a, py - 2),
      Offset(px, py - a * 2 - 2),
      icon..strokeWidth = 1.5 * math.min(sx, sy),
    );
  ...
  void _drawSinks(
    ...
    void drawOneSinkUnit(double x) {
      ...
      final unitRR = RRect.fromRectAndRadius(
        unitRect,
      ...
      final drainC = Offset(
        basinRect.center.dx,
        basinRect.top + basinRect.height * 0.45,
      );
      canvas.drawCircle(
        drainC,
        2.5 * math.min(sx, sy),
      ...
      // Faucet (detailed)
      final faucetBaseC = Offset(
        unitRect.center.dx,
        unitRect.bottom - unitRect.height * 0.3,
      );
      ...
      pipePath.lineTo(
        faucetBaseC.dx - pW / 2,
        faucetBaseC.dy - unitRect.height * 0.25,
      );
      pipePath.arcToPoint(
        Offset(
          faucetBaseC.dx + pW / 2,
  ...
  void _drawKitchen(Canvas canvas, Rect raw, double sx, double sy) {
    ...
    final hobRect = Rect.fromCenter(
      center: Offset(r.center.dx, hobTop + hobH / 2),
      width: hobW,
      height: hobH,
    );
    _roundRect(
    ...
    final p = Paint()
      ...
      ..strokeWidth = 1.2;
    canvas.drawCircle(
      Offset(hobRect.left + hobW * 0.3, hobRect.top + hobH * 0.3),
      rad,
      p,
    );
    canvas.drawCircle(
      Offset(hobRect.right - hobW * 0.3, hobRect.top + hobH * 0.3),
      rad,
      p,
    );
    canvas.drawCircle(
      Offset(hobRect.left + hobW * 0.3, hobRect.bottom - hobH * 0.3),
      rad * 0.8,
      p,
    );
    canvas.drawCircle(
      Offset(hobRect.right - hobW * 0.3, hobRect.bottom - hobH * 0.3),
      rad * 0.8,
      p,
    );
    ...
    final sinkRect = Rect.fromCenter(
      center: Offset(r.center.dx, sinkTop + sinkH / 2),
      width: sinkW,
      height: sinkH,
    );
    ...
    final bR = Rect.fromCenter(
      center: Offset(sinkRect.center.dx, sinkRect.bottom - bH / 2 - 6 * sy),
      width: bW,
      height: bH,
    );
    ...
    for (int i = 0; i < 2; i++) {
      ...
      canvas.drawRRect(
        RRect.fromRectAndRadius(backR, const Radius.circular(2)),
  ...
  void _drawHedge(Canvas canvas, List<Offset> points, double sx, double sy) {
    ...
    canvas.drawPath(
      path,
      Paint()
        ..color = kPlantDark.withOpacity(0.5)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 1.0,
    );
    ...
    final patternPaint = Paint()
      ..color = kPlantDark.withOpacity(0.7)
      ..strokeWidth = 1.0;
